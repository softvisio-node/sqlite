...
const externalResources = require( "@softvisio/utils/external-resources" );

let DEFAULT_ADDON;

const resource = externalResources.add( `softvisio-node/sqlite/resources/node-v${process.versions.modules}-${process.platform}-${process.arch}.node` );
