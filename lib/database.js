...
const resource = externalResources.add( `softvisio-node/sqlite/resources/node-v${process.versions.modules}-${process.platform}-${process.arch}.node`, { "location": "lib/binaries", "resolve": __filename } );
