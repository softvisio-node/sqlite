...
const resource = externalResources.add( `softvisio-node/sqlite/resources/node-v${process.versions.modules}-${process.platform}-${process.arch}.node`, __filename, { "location": "lib/binaries" } );
